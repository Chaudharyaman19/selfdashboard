  ...
  return (
    <>
      ...
      <div className="leads-overview-container">
        ...
        <div className="amount-closed">
          <h2>Amount Closed by Lead Source</h2>
          <ul>
            <li>
              <strong>By Web</strong> 64%
            </li>
            <li>
              <strong>Phone Call</strong> 23%
            </li>
            <li>
              <strong>E-mail</strong> 44%
            </li>
            <li>
              <strong>Advertisement</strong> 79%
            </li>
            <li>
              <strong>By Application</strong> 76%
            </li>
          </ul>
        </div>
      </div>
